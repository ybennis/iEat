...
<form method="post" action=<%= response.encodeURL(request.getContextPath()+"/Home?action=doLogin")  %> >

<input type="hidden" name="action" value="doLogin"> 

<table>
<tr><td class="align-right">Email address :</td> <td> <input type= "text" name="email" value="<%= request.getAttribute("email")%>"></td> </tr>
<tr><td class="align-right">password :</td> <td> <input type= "text" name="password" value="<%= request.getAttribute("password")%>"></td> </tr>
