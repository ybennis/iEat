		  ...
		  <div data-role="page" data-control-title="Home" id="page1">
		      <div data-role="panel" id="panel7" data-position="left" data-display="reveal" data-theme="a">
		          <ul data-role="listview" data-divider-theme="h" data-inset="false">
		              ...
		              <li data-theme="a">
		                  <a  data-inline="true" method="get" href=<%= response.encodeURL(request.getContextPath()+"/Home?action=find") %> data-transition="slide">
		                      Food Finder
		                  </a>
		              </li>
		              <li data-role="list-divider" role="heading">
		      ...
		      <div data-role="panel" id="panel3" data-position="left" data-display="reveal" data-theme="a">
		          <ul data-role="listview" data-divider-theme="h" data-inset="false">
		              ...
		              <li data-theme="a">
		                  <a method="get" href=<%= response.encodeURL(request.getContextPath()+"/ISpy?action=find") %> data-transition="slide">
		                      Food Finder
		                  </a>
		              </li>
		              <li data-role="list-divider" role="heading">
		      ...
		      <div data-role="panel" id="panel5" data-position="left" data-display="reveal" data-theme="a">
		          <ul data-role="listview" data-divider-theme="h" data-inset="false">
		              ...
		              <li data-theme="a">
		                  <a data-role="button" data-inline="true" method="get" href=<%= response.encodeURL(request.getContextPath()+"/Home?action=find") %> data-transition="slide">
		                      Food Finder
		                  </a>
		              </li>
		              <li data-role="list-divider" role="heading">
